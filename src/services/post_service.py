...
class PostService:
    ...
    @staticmethod
    def crear_post(titulo, contenido, id_usuario, codigo_modulo=None, imagen_post=None):
        return PostRepository.create(titulo, contenido, id_usuario, codigo_modulo, imagen_post)
